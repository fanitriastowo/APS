 ...
 * @author anonymous
 */
public class BilingTunaiTableModel extends AbstractTableModel {
    ...
    public void save(TagihanTunai tunai) {
        list.add(tunai);
        fireTableRowsInserted(getRowCount() - 1, getRowCount() - 1);
    }

    public void update(int index, TagihanTunai tunai) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 1:
                return tagihanTunai.getNis();
            case 2:
                return tagihanTunai.getNama();
            default:
                return null;
        }
    }
